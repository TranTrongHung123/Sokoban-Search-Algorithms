...
def astar_search_manhattan(board, list_check_point):
    ...
    start_state = utils.state(board, None, list_check_point, 1)
    ...
    while not heuristic_queue.empty():
        ...
        for next_pos in list_can_move:
            ...
            new_state = utils.state(new_board, now_state, list_check_point, 1)
